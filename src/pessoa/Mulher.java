...
public class Mulher extends PessoaIMC{
    ...
    public Mulher(String nome, String sobreNome, GregorianCalendar dataNasc) {
        super(nome, sobreNome, dataNasc);
    }

    public Mulher(String nome, String sobreNome, GregorianCalendar dataNasc, String numCPF,float peso, float altura) {
